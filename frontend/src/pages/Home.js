      ...
      <div className="relative bg-blue-600">
        <div className="absolute inset-0">
          <img
            ...
            src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1907&q=80"
            alt="People working"
          />
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Our AI-powered algorithm matches you with jobs that align with your skills and preferences.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Easy Application Process</h3>
                  <p className="mt-2 text-base text-gray-500">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Get instant notifications about job matches and application status updates.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Access professional development resources and career guidance.
                  </p>
                </div>
              </div>
            </div>
